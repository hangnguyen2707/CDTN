  ...
  />
      ...
      <div style={{ display: 'flex', flexDirection: 'row', gap: '20px', marginTop: '20px' }}>
        ...
        <table>
          ...
          <UpdateSendToAccount showModal={isUpdateModalOpen} handleClose={handleCloseUpdateModal} selectedPackage={selectedPackage} />
        </table>
...
export default PointStaffSendToAccount;
